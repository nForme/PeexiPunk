...
const upArrow = (
  ...
  <g clip-path="url(#clip0_9_6)">
    <rect width="16" height="10" transform="matrix(1 0 0 -1 0 10)" fill="#121212"/>
...
const Filter: React.FC = () => {
  const filterOptions: string[] = ["All", "Game", "News", "Announce", "Update"];
  const [isDropdownOpen, setIsDropdownOpen] = useState<boolean>(false);
  const [selectedFilter, setSelectedFilter] = useState<string>("Game");
  ...
  return (
    <div className="filter-container">
      <div className={`filter ${isDropdownOpen ? "active" : ""}`}>
